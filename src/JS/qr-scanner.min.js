class e {
    ...
    static scanImage(a, b = null, c = null, d = null, f = !1, k = !1) {
      let h = c instanceof Worker,
        g = Promise.all([c || e.createQrEngine(), e._loadImage(a)]).then(
          ([a, g]) => {
            c = a;
            let k;
      ...
      requestAnimationFrame(() => {
        1 >= this.$video.readyState
          ...
          : this._qrEnginePromise
              .then((a) =>
                e.scanImage(this.$video, this._scanRegion, a, this.$canvas)
              )
    ...
    static _loadImage(a) {
      ...
      if (
        ...
        let b = new Image();
        b.src =
          a instanceof File || a instanceof Blob ? URL.createObjectURL(a) : a;
